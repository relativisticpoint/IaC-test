...
resource "azurerm_storage_account" "sg1" {
  name                     = "csestoragelogo-hani" # add your name to make it unique. Can only consist of lowercase letters and numbers, and must be between 3 and 24 characters long.
...
resource "azurerm_storage_account" "sg2" {
  name                     = "csestoragelogs-hani" # add your name to make it unique. Can only consist of lowercase letters and numbers, and must be between 3 and 24 characters long.
  resource_group_name      = var.rg_name
  location                 = var.location
...
resource "azurerm_mysql_flexible_server" "serverformation1" {
  ...
  location               = var.location
  resource_group_name    = var.rg_name
  administrator_login    = "adminrelativisticp"
  administrator_password = "formationrelativisticp0!"
